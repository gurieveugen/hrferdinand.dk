...
$thumbnailsrc = $domsxe->attributes()->src;
?>
				<img src="<?php bloginfo('stylesheet_directory'); ?>/scripts/timthumb.php?src=<?php echo str_replace(get_bloginfo('url'), "", $thumbnailsrc); ?>&w=75&h=115" align="right" alt="<?php the_title(); ?>" style="border-width:0px;" />
<?php } ?>
